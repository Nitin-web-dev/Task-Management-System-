...
export default function RegisterPage() {
  ...
  const onsubmitt = async (data) => {
    try {
        // todo: handle error for fields correctly there is a bug for same email,password can't display error correctly
          ...
          <div className="mt-20 flex w-full flex-col items-start justify-start p-6 md:w-1/2 lg:px-10">
            ...
            <form onSubmit={handleSubmit(onsubmitt)}>
              <div className="my-14 flex w-full flex-col items-start justify-start gap-4">
                ...
                <div className="mr-4 flex items-center">
                  <input
                    {...register("agreeTermAndCondition", {
                  ...
                  <div className="ml-3 text-sm leading-6">
                    ...
                    {/* 🔴 Shows error when trying to submit without checking */}
                    {errors.agreeTermAndCondition && (
                      <p className="text-red-500 text-sm mt-1">
                        {errors.agreeTermAndCondition.message}
                      </p>
                    )}
                  </div>
                </div>
